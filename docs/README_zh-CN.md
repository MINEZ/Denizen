...
**打开完整的玩家物品栏。** 玩家物品栏共 41 格，而容器界面按格数除以 9 取整来定行数，打开时因而只显示前 36 格，盔甲与副手恰被截去。现改以五行的容器打开，41 格皆可触及，多出的 4 格弃置不用。需要 Paper 26.2，其余版本维持原有行为。
